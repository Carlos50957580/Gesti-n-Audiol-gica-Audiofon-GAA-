{{-- resources/views/audiologist-fees/settings.blade.php --}}
<x-app-layout>
    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-0">Configuración de Honorarios</h4>
        ...
        <div class="col-md-3">
            <div class="card stat-card shadow-sm h-100">
                <div class="card-body d-flex align-items-center gap-3 py-3">
                    ...
                    <div>
                        <div class="text-muted" style="font-size:.72rem;font-weight:700;">Medicos</div>
                        <div class="fw-bold fs-4 lh-1 mt-1">{{ $audiologists->count() }}</div>
                    </div>
            ...
            <div class="card shadow-sm" style="border-radius:.75rem;border:none;">
                ...
                <div class="card-body p-4">
                    ...
                    <form id="settings-form" novalidate>
                        ...
                        <p class="section-label"><i class="ri-user-settings-line me-1"></i>Audíólogo</p>
                        <div class="mb-4">
                            <select id="audiologist-id" class="form-select" required>
            ...
            <div class="card shadow-sm" style="border-radius:.75rem;border:none;">
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap py-3" style="border-bottom:1px solid #f0f2f7;background:#fff;">
                    ...
                    <div class="position-relative" style="width:200px;">
                        ...
                        <input type="text" id="search-settings" class="form-control" placeholder="Buscar Medico...">
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table settings-table mb-0">
                            ...
                            <tbody id="settings-tbody">
                                ...
                                <tr class="anim-row" data-id="{{ $setting->id }}" data-audiologist="{{ strtolower($setting->audiologist->name) }}">
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div>
                                                <div class="fw-semibold" style="font-size:.9rem;">{{ $setting->audiologist->name }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex gap-1 justify-content-center">
                                            ...
                                            <button type="button" class="btn btn-action bg-danger-subtle text-danger"
                                                    title="Eliminar" onclick="openDeleteModal({{ $setting->id }}, '{{ addslashes($setting->audiologist->name) }}')">
                                ...
                                <tr>
                                    <td colspan="5">
                                        <div class="text-center py-5">
                                            ...
                                            <p class="text-muted small mt-1">Seleccione un Medico y configure su honorario</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse
...
const URL_BASE = "{{ route('audiologist-fees.settings') }}";
...
function filterSettings() {
    ...
    rows.forEach(tr => {
        const audiologistName = tr.dataset.audiologist || '';
        const match = !search || audiologistName.includes(search);
...
async function editSetting(id) {
    try {
        ...
        document.getElementById('audiologist-id').value = setting.audiologist_id;
        document.getElementById('audiologist-id').disabled = true;
...
async function saveSetting() {
    ...
    const audiologistId = document.getElementById('audiologist-id').value;
    if (!audiologistId) {
        document.getElementById('err-audiologist_id').textContent = 'Seleccione un Medico';
        document.getElementById('audiologist-id').classList.add('is-invalid');
        return;
    }
...
function clearForm() {
    ...
    document.getElementById('audiologist-id').value = '';
    document.getElementById('audiologist-id').disabled = false;
