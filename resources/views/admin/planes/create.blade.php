            ...
            <div class="row mb-3">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Registrar Nuevo Plan de Estudio</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select class="form-select @error('university_id') is-invalid @enderror" 
                                            ...
                                            {{-- Asegúrate de que $universidades se pasa al template --}}
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('nivel_academico') is-invalid @enderror" 
                                            ...
                                            @php
                                                $niveles = ['Grado', 'Maestría', 'Doctorado'];
                                            @endphp
                                            @foreach ($niveles as $nivel)
                                                <option value="{{ $nivel }}" {{ old('nivel_academico') == $nivel ? 'selected' : '' }}>
                                                    {{ $nivel }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                                  ...
                                                  name="descripcion" 
                                                  rows="4" 
                                                  placeholder="Descripción breve del plan de estudio">{{ old('descripcion') }}</textarea>
                                        @error('descripcion')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
