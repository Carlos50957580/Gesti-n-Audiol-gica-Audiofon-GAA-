...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Nuevo Impuesto</h4>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                   value="{{ old('name') }}" placeholder="Ej: ITBIS" required>
                            @error('name')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" 
                                   value="{{ old('code') }}" placeholder="Ej: ITBIS" required>
                            @error('code')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" name="rate" class="form-control @error('rate') is-invalid @enderror" 
                                       value="{{ old('rate') }}" step="0.01" min="0" max="100" placeholder="18.00" required>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" 
                                      rows="3" placeholder="Descripción del impuesto">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="ri-save-line"></i> Guardar Impuesto
                            </button>
                            <a href="{{ route('taxes.index') }}" class="btn btn-secondary">
                                Cancelar
                            </a>
        ...
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="card d-inline-block" style="min-width: 200px;">
                    <div class="card-body">
                        <h4 id="previewName" class="mb-1">{{ old('name', 'ITBIS') }}</h4>
                        <code id="previewCode" class="text-muted">{{ old('code', 'ITBIS') }}</code>
                        <div class="mt-2">
                            <span class="badge bg-info fs-14" id="previewRate">{{ old('rate', '18.00') }}%</span>
                        </div>
                        <div class="mt-2">
                            <span class="badge {{ old('is_default') ? 'bg-success' : 'bg-secondary' }}" id="previewDefault">
                                {{ old('is_default') ? '⭐ Por Defecto' : 'No es por defecto' }}
                            </span>
                        </div>
                        <div class="mt-1">
