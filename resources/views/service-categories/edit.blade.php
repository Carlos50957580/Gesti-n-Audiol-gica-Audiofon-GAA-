...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Editar Servicio: {{ $service->name }}</h4>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" 
                                   value="{{ old('code', $service->code) }}" placeholder="Ej: CON-001">
                            @error('code')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                   value="{{ old('name', $service->name) }}" placeholder="Ej: Consulta General" required>
                            @error('name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" 
                                      rows="2">{{ old('description', $service->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" name="duration_minutes" class="form-control @error('duration_minutes') is-invalid @enderror" 
                                   value="{{ old('duration_minutes', $service->duration_minutes) }}" min="0" placeholder="30">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-check form-switch mt-2">
                                ...
                                <input type="checkbox" name="requires_authorization" class="form-check-input" id="requiresAuth" 
                                       value="1" {{ old('requires_authorization', $service->requires_authorization) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-check form-switch mt-2">
                                ...
                                <input type="checkbox" name="requires_clinical_record" class="form-check-input" id="requiresHC" 
                                       value="1" {{ old('requires_clinical_record', $service->requires_clinical_record) ? 'checked' : '' }}>
                        ...
                        <div class="col-12">
                            ...
                            <div id="insuranceCoverageContainer">
                                @php $coverageIndex = 0; @endphp
                                @foreach($service->insuranceCoverage as $coverage)
                                <div class="row g-2 mb-2 coverage-row">
                                    <input type="hidden" name="insurance_coverage[{{ $coverageIndex }}][id]" value="{{ $coverage->id }}">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check form-switch mt-2">
                                            ...
                                            <input type="checkbox" name="insurance_coverage[{{ $coverageIndex }}][requires_authorization]" 
                                                   ...
                                                   value="1" {{ $coverage->requires_authorization ? 'checked' : '' }}>
                                            <label class="form-check-label" for="authCoverage{{ $coverageIndex }}">
                                                Requiere Auth
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <div class="col-12">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="ri-save-line"></i> Actualizar Servicio
                            </button>
                            <a href="{{ route('services.index') }}" class="btn btn-secondary">
                                Cancelar
                            </a>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let coverageIndex = {{ count($service->insuranceCoverage) }};
